    ...
    >
        ...
        >
          <div className="flex flex-col gap-8">
            ...
            <DetailRow
              icon={<FoodIcon />}
              label="Cena"
              value="20:00 - 21:00 hrs"
              sub="¡No te lo pierdas!"
            />
          </div>
        </div>
      </motion.section>
      ...
      >
        <div
          ...
          style={{
            background: "#FFFFFF",
            border: "1px solid rgba(184,143,45,0.15)",
            boxShadow: "0 8px 40px rgba(184,143,45,0.07)",
          }}
        >
          <div className="flex flex-col gap-8">
            <DetailRow
              ...
              value="Tu presencia es el mejor regalo"
              sub="Se contará con mesa de regalos"
            />
            <DetailRow
              icon={<MoneyIcon />}
              label="Lluvia de Sobres"
              value="Buzón de Dinero"
              sub="Un detalle en efectivo será bienvenido"
            />
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-3">
          <BeerIcon />
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.1rem", color: "#6B8EBF", fontStyle: "italic" }}>
            Eres libre de traer tu propia cerveza
          </p>
        </div>
      </motion.section>
...
function GiftIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#B88F2D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
function BeerIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#6B8EBF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 11h1a3 3 0 0 1 0 6h-1" />
      <path d="M9 12v6" />
      <path d="M13 12v6" />
      <path d="M15 6H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2z" />
    </svg>
  );
}
